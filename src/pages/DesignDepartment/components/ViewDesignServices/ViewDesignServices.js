...
export default function ViewDesignServices() {

    const navigate = useNavigate();
    const location = useLocation().search;
    const serviceId = parseInt(location.slice(1));
    ...
    const servicesUtailty = new Services();

    useEffect(() => {

        servicesUtailty.getSingleServices(serviceId, setServices);
            ...
            <div className='grid grid-cols-12 gap-5'>
                ...
                <div className='col-span-8'>
                    ...
                    <div className='my-10 flex items-center justify-end'>
                        ...
                        <button className='p-2 px-5 border-2 border-[var(--min-color)] bg-[var(--min-color)] rounded-[5px] me-4 font-medium text-white'>Save Changes</button>
